...
export default function BattleWinnerModal({ winners, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center px-2 sm:px-4 py-3 sm:py-4 animate-fadeIn overflow-hidden">
      {/* Backdrop */}
      <div
        onClick={onClose}
      ...
      >
        ...
        <div className="relative flex-1 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="text-center mb-5 sm:mb-8 shrink-0 px-7 sm:px-8">
            <div className="flex justify-center mb-4">
              <span className="bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 dark:border-emerald-500/30 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.14em] sm:tracking-[0.2em] px-4 sm:px-6 py-2 rounded-full flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto pr-1 sm:pr-2 -mr-1 sm:-mr-2 custom-scrollbar min-h-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-2">
              {displayWinners.map((winner, idx) => (
                ...
                >
                  ...
                  <h3 className="text-xs sm:text-sm font-black text-[var(--accent)] leading-tight uppercase tracking-tighter group-hover:text-[var(--text-primary)] transition-colors mb-1 truncate">
                    {winner.winner || "TBD"}
                  </h3>
            ...
            {/* Pre-battle fallback intentionally disabled.
